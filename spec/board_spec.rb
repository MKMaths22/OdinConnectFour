...
describe Board do
  ...
  describe '#try_adding_tile' do
    context 'the column has space' do
      let(:first_cells_array) do
        [['R', 'R', 'Y', 'R', nil, nil], ['Y', 'Y', 'R', 'Y', nil, nil], Array.new(6), Array.new(6), Array.new(6),
         Array.new(6), Array.new(6)]
      end
      let(:result_array) do
        [['R', 'R', 'Y', 'R', 'R', nil], ['Y', 'Y', 'R', 'Y', nil, nil], Array.new(6), Array.new(6), Array.new(6),
         Array.new(6), Array.new(6)]
      end
    ...
    context 'the column is full' do
      let(:first_cells_array) do
        [['R', 'R', 'Y', 'R', nil, nil], %w[Y Y R Y Y R], Array.new(6), Array.new(6), Array.new(6), Array.new(6),
         Array.new(6)]
      end
      it "returns 'full' " do
    ...
    context 'this ends the game in a win' do
      let(:first_cells_array) do
        [['R', 'R', 'R', nil, nil, nil], ['Y', 'Y', 'R', 'Y', 'Y', nil], Array.new(6), Array.new(6), Array.new(6),
         Array.new(6), Array.new(6)]
      end
      let(:next_cells_array) do
        [['R', 'R', 'R', 'R', nil, nil], ['Y', 'Y', 'R', 'Y', 'Y', nil], Array.new(6), Array.new(6), Array.new(6),
         Array.new(6), Array.new(6)]
      end
    ...
    context 'ends the game in a win with the board full' do
      let(:first_cells_array) do
        [%w[R Y R Y R Y], %w[Y R Y R Y R], %w[R Y R Y R Y], ['R', 'Y', 'R', 'Y', 'R', nil], %w[R Y R Y R Y], %w[Y R Y R Y R],
         %w[R Y R Y R Y]]
      end
      let(:next_cells_array) do
        [%w[R Y R Y R Y], %w[Y R Y R Y R], %w[R Y R Y R Y], %w[R Y R Y R R], %w[R Y R Y R Y], %w[Y R Y R Y R],
         %w[R Y R Y R Y]]
      end
      it 'declares the game to be won' do
    ...
    context 'this ends the game in a draw' do
      let(:first_cells_array) do
        [%w[Y R Y Y R Y], %w[R Y R R Y R], %w[Y R Y Y R Y], %w[R Y R R Y R], %w[Y R Y Y R Y], %w[R Y R R Y R],
         ['Y', 'R', 'Y', 'Y', 'R', nil]]
      end
      let(:next_cells_array) do
        [%w[Y R Y Y R Y], %w[R Y R R Y R], %w[Y R Y Y R Y], %w[R Y R R Y R], %w[Y R Y Y R Y], %w[R Y R R Y R],
  ...
  describe '#vertical_connect_four?' do
    let(:first_cells_array) do
      [['R', 'R', 'R', 'R', nil, nil], ['Y', 'Y', 'Y', nil, nil, nil], Array.new(6), Array.new(6), Array.new(6),
       Array.new(6), Array.new(6)]
    end
    it 'returns true' do
  ...
  describe '#horizontal_connect_four?' do
    let(:first_cells_array) do
      [['R', 'Y', 'Y', 'R', nil, nil], ['Y', 'Y', 'Y', nil, nil, nil], ['R', 'R', 'Y', 'Y', nil, nil],
       ['Y', 'R', 'Y', nil, nil, nil], Array.new(6), Array.new(6), Array.new(6)]
    end
    it 'returns true' do
  ...
  describe '#north_east_connect_four?' do
    let(:first_cells_array) do
      [['Y', 'Y', 'R', nil, nil, nil], ['Y', 'R', nil, nil, nil, nil], ['R', 'R', 'R', nil, nil, nil],
       ['Y', 'Y', 'Y', 'R', nil, nil], ['Y', 'R', 'Y', 'R', 'R', nil], ['R', 'Y', 'Y', 'R', 'Y', nil], ['R', 'Y', 'R', 'Y', 'R', nil]]
    end
    it 'returns true' do
  ...
  describe '#north_west_connect_four?' do
    let(:first_cells_array) do
      [['R', 'Y', 'R', 'Y', 'R', nil], ['R', 'Y', 'Y', 'R', 'Y', nil], ['Y', 'R', 'Y', 'R', 'R', nil],
       ['Y', 'Y', 'Y', 'R', nil, nil], ['R', 'R', 'R', nil, nil, nil], ['Y', 'R', nil, nil, nil, nil], ['Y', 'Y', 'Y', nil, nil, nil]]
    end
    it 'returns true' do
  ...
  describe '#check_if_game_won?' do
    let(:first_cells_array) do
      [['R', 'R', 'R', nil, nil, nil], ['Y', 'Y', 'Y', nil, nil, nil], Array.new(6), Array.new(6), Array.new(6),
       Array.new(6), Array.new(6)]
    end
    it 'returns false' do
  ...
  describe '#check_if_game_drawn?' do
    context 'the board is not full' do
      let(:first_cells_array) do
        [%w[R R R Y R Y], ['Y', 'Y', 'Y', nil, nil, nil], Array.new(6), Array.new(6), Array.new(6), Array.new(6),
         Array.new(6)]
      end
      it 'returns false' do
